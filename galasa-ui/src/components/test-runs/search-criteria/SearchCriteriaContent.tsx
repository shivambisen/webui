...
export default function SearchCriteriaContent({
  ...
  const filterableFields: FilterableField[] = [
    {
      id: TEST_RUNS_QUERY_PARAMS.RUN_NAME,
      label: translations('fields.runName.label'),
      placeHolder: 'any',
      description: translations('fields.runName.description'),
    },
    {
      id: TEST_RUNS_QUERY_PARAMS.REQUESTOR,
      label: translations('fields.requestor.label'),
      placeHolder: 'any',
    ...
    },
    {
      ...
      placeHolder: 'any',
      description: translations('fields.group.description'),
    },
    {
      id: TEST_RUNS_QUERY_PARAMS.BUNDLE,
      label: translations('fields.bundle.label'),
      placeHolder: 'any',
      description: translations('fields.bundle.description'),
    },
    {
      id: TEST_RUNS_QUERY_PARAMS.SUBMISSION_ID,
      label: translations('fields.submissionId.label'),
      placeHolder: 'any',
      description: translations('fields.submissionId.description'),
    },
    {
      id: TEST_RUNS_QUERY_PARAMS.TEST_NAME,
      label: translations('fields.testName.label'),
      placeHolder: 'any',
      description: translations('fields.testName.description'),
    },
    {
      id: TEST_RUNS_QUERY_PARAMS.STATUS,
      label: translations('fields.status.label'),
      placeHolder: 'any',
      description: translations('fields.status.description'),
    },
    {
      id: TEST_RUNS_QUERY_PARAMS.TAGS,
      label: translations('fields.tags.label'),
      placeHolder: 'any',
      description: translations('fields.tags.description'),
    },
    {
      id: TEST_RUNS_QUERY_PARAMS.RESULT,
      label: translations('fields.result.label'),
      placeHolder: 'any',
      description: translations('fields.result.description'),
    },
  ];
  ...
  const renderComponent = (field: FilterableField) => {
    ...
    const checkboxProps = {
      title: field.description,
      items:
        field.id === TEST_RUNS_QUERY_PARAMS.RESULT ? resultsNames : Object.values(TEST_RUNS_STATUS),
      selectedItems:
        field.id === TEST_RUNS_QUERY_PARAMS.RESULT ? selectedResults : selectedStatuses,
      onChange:
        field.id === TEST_RUNS_QUERY_PARAMS.RESULT ? setSelectedResults : setSelectedStatuses,
      onSubmit: handleSave,
      onCancel: handleCancel,
      disableSaveAndReset: isSaveAndResetDisabled,
    };
              ...
              <StructuredListRow head>
                <div className={styles.rowWrapper}>
                  ...
                  <StructuredListCell head>
                    {translations('table.allowedValues')}
                  </StructuredListCell>
                </div>
              </StructuredListRow>
            </StructuredListHead>
