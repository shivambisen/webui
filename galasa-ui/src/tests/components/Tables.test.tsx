...
test('creates Galasa Token Table row', () => {
  const rows = [
    { id: '4321', tokenName: 'Token1Example', scope: 'ALL', expires: '2023-10-22' },
    { id: '5678', tokenName: 'Token2Example', scope: 'Local', expires: '2023-09-10' },
  ];
  ...
  const expectedToken2 = (
    <TableRow key="5678">
      <TableCell>Token2Example</TableCell>
