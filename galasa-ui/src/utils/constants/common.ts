...
// 6 second duration for warning notifications.
const WARNING_NOTIFICATION_VISIBLE_MILLISECS = 6000;
...
export { CLIENT_API_VERSION,COLORS, MAX_DISPLAYABLE_TEST_RUNS, MINUTE_MS, 
  ...
  SINGLE_RUN_QUERY_PARAMS, WARNING_NOTIFICATION_VISIBLE_MILLISECS, LOCALE_TO_FLATPICKR_FORMAT_MAP};
